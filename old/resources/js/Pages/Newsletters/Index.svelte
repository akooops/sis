    ...
    async function deleteNewsletter(newsletterId) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const errorMessage =
                    errorData.message ||
                    "Error deleting newsletter. Please try again.";
            ...
            >
                <div class="flex flex-col gap-1">
                    ...
                    <p class="text-sm text-secondary-foreground">
                        Manage your website newsletters and content
                    </p>
                </div>
                <div class="flex items-center gap-3">
                    {#if hasPermission("admin.newsletters.store")}
                        <a
                                ...
                                {#if loading}
                                    ...
                                    {#each Array(perPage) as _, i}
                                        <tr>
                                            <td class="p-4">
                                                <div
                                                    class="kt-skeleton w-4 h-4 rounded"
                                                ></div>
                                            </td>
                                            <td class="p-4">
                                                <div
                                                    class="kt-skeleton w-8 h-4 rounded"
                                                ></div>
                                            </td>
                                            <td class="p-4">
                                                <div
                                                ...
                                                >
                                                    <div
                                                        class="kt-skeleton w-10 h-10 rounded-lg"
                                                    ></div>
                                                    <div
                                                        class="flex flex-col gap-1"
                                                    >
                                                        <div
                                                            class="kt-skeleton w-24 h-4 rounded"
                                                        ></div>
                                                        <div
                                                            class="kt-skeleton w-16 h-3 rounded"
                                                        ></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="p-4">
                                                <div
                                                    class="kt-skeleton w-16 h-6 rounded"
                                                ></div>
                                            </td>
                                            <td class="p-4">
                                                <div
                                    ...
                                    <tr>
                                        <td colspan="8" class="p-10">
                                            ...
                                            >
                                                <div class="mb-4">
                                                    <i
                                                        class="ki-filled ki-form text-4xl text-muted-foreground"
                                                    ></i>
                                                </div>
                                                <h3
                                                ...
                                                {#if hasPermission("admin.newsletters.store")}
                                                    ...
                                                    >
                                                        <i
                                                            class="ki-filled ki-plus text-base"
                                                        ></i>
                                            ...
                                            <td class="text-center">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {#if hasPermission("admin.newsletters.show")}
                                                                <div
                                                                    class="kt-menu-item"
                                                                >
                                                                    <a
                                                            ...
                                                            {/if}
                                                            {#if hasPermission("admin.newsletters.destroy")}
                                                                <div
