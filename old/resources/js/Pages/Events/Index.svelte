<script>
    ...
    async function fetchEvents() {
        ...
        try {
            ...
            const response = await fetch(route('admin.events.index', {
                page: currentPage,
                perPage: perPage,
                search: search
            }), {
    ...
    async function deleteEvent(eventId) {
        ...
        try {
            ...
            const response = await fetch(route('admin.events.destroy', { event: eventId }), {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
            ...
            if (response.ok) {
                ...
                const errorMessage = errorData.message || 'Error deleting event. Please try again.';
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex flex-col gap-1">
                    <h1 class="text-2xl font-bold text-mono">Events Management</h1>
                    <p class="text-sm text-secondary-foreground">
                        Manage your website events and content
                    </p>
                </div>
                <div class="flex items-center gap-3">
                    {#if hasPermission('admin.events.store')}
                    <a href="{route('admin.events.create')}" class="kt-btn kt-btn-primary">
            ...
            <div class="kt-card">
                <div class="kt-card-header">
                    <div class="kt-card-toolbar">
                        ...
                        <select class="kt-select max-w-48 w-48" bind:value={facilityFilter} on:change={() => { currentPage = 1; fetchEvents(); }}>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[200px]">
                                        <span class="kt-table-col">
                                            <span class="kt-table-col-label">Event</span>
                                        </span>
                                    </th>
                                    ...
                                    <tr>
                                        <td colspan="8" class="p-10">
                                            <div class="flex flex-col items-center justify-center text-center">
                                                ...
                                                <h3 class="text-lg font-semibold text-mono mb-2">No events found</h3>
                                ...
                                {:else}
                                    ...
                                    {#each events as event}
                                        <tr class="hover:bg-muted/50">
                                            <td>
                                                <input class="kt-checkbox kt-checkbox-sm" type="checkbox" value={event.id}/>
                                            </td>
                                            <td>
                                                <span class="text-sm font-medium text-mono">#{event.id}</span>
                                            </td>
                                            <td>
                                                <div class="flex items-center gap-3">
                                            ...
                                            <td>
                                                <span class="kt-badge {getStatusBadgeClass(event.status)}">
                                                ...
                                                <div class="kt-menu flex-inline" data-kt-menu="true">
                                                    <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                                                        ...
                                                        <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                            {#if hasPermission('admin.events.show')}
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link" href={route('admin.events.show', { event: event.id })}>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link" href={route('admin.events.edit', { event: event.id })}>
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            {/if}
                                                            {#if hasPermission('admin.events.destroy')}
                                                                <div class="kt-menu-separator"></div>
                                                                <div class="kt-menu-item">
                                                                    <button class="kt-menu-link" on:click={() => deleteEvent(event.id)}>
                                                                        <span class="kt-menu-icon">
