...
@section('canonical', route('newsletters'))
...
<section>
    <div class="container pb-14 pt-6">
        ...
        <div class="pt-6" data-aos="fade-up" data-aos-duration="2000">
            <x-panel id="newsletters-panel" :title="getLanguageKeyLocalTranslation('newsletters_page_collapse_title')">
                <div class="overflow-x-auto">
                    <table class="table">
                        <thead>
                            <tr>
                                <th class="w-[25px]">#</th>
                                <th class="w-[90%]">{{ getLanguageKeyLocalTranslation('newsletters_page_table_header_file') }}</th>
                                <th>{{ getLanguageKeyLocalTranslation('newsletters_page_table_header_option') }}</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            @foreach ($newsletters as $key => $newsletter)
                                <tr>
                                    ...
                                    <td>{{ $newsletter->getLocalTranslation('title') }}</td>
                                    <td>
                                        <a href="{{ $newsletter->newsletterUrl }}" target="_blank" rel="noopener"
                                            class="btn btn-sm">
