...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Значение поля :attribute встречалось в утечке данных. Пожалуйста, выберите другое значение.',
    ],
    ...
    'required_without_all' => 'Поле :attribute обязательно, когда ни одно из значений :values не присутствует.',
    ...
    */
    'phone' => 'Поле :attribute должно содержать корректный номер телефона в международном формате (например, +213555123456).',
    'upload_invalid' => 'Выбранный для :attribute файл некорректен.',
    'upload_unscanned' => 'Поле :attribute ещё не прошло проверку безопасности.',
    'captcha' => 'Проверка не пройдена. Подтвердите, что вы не робот, и попробуйте ещё раз.',
    'captcha_unavailable' => 'Не удалось выполнить проверку прямо сейчас. Пожалуйста, повторите попытку через несколько секунд.',
    'step' => 'Значение поля :attribute должно быть кратно :step.',
    'ip_or_cidr' => 'Поле :attribute должно содержать корректный IP-адрес или диапазон CIDR (например, 203.0.113.5 или 203.0.113.0/24).',
