...
return [
    ...
    */
    ...
    'step' => 'يجب أن تكون قيمة الحقل :attribute من مضاعفات :step.',
    'ip_or_cidr' => 'يجب أن يكون حقل :attribute عنوان IP صالحًا أو نطاق CIDR (مثال: 203.0.113.5 أو 203.0.113.0/24).',
