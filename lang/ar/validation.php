...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            ...
            'impossible' => 'رقم الهاتف غير ممكن.',
            'international_format' => 'يجب أن يبدأ رقم الهاتف برمز الدولة (+).',
            'invalid_country_code' => 'رمز الدولة غير صحيح.',
            'not_a_number' => 'القيمة المدخلة ليست رقم هاتف صحيح.',
    ...
    */
    ...
    'attributes' => [
        'g-recaptcha-response' => 'تحدي الروبوت',
        'firstname'             => 'الإسم الأول',
        'lastname'             => 'إسم العائلة',
        'message'             => 'الرسالة',
        'attachment'             => 'الملف',
        'last_company'             => 'أخر شركة عملت لها',
        'start'             => 'تاريخ البدء',
        'salary'             => 'متطلبات الراتب',
        'position'             => 'الدور',
