...
/**
 * Where an achievement sits editorially. Only Published is served.
 *
 *  - Draft     : the default. Being written, never announced.
 *  - Scheduled : finished, waiting for published_at. achievements:publish-scheduled
 *                flips it (App\Console\Commands\PublishScheduledAchievements).
 ...
 *
 * Published is reachable from every state so an achievement can always go back up,
 * and Hidden from every state that carries a public commitment so it can always
 * come down. Draft cannot be reached from Published — pulling a live achievement is an
 ...
 */
abstract class AchievementStatus extends State
{
