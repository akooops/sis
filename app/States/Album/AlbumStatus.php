...
/**
 * Where an album sits editorially. Only Published is served.
 *
 *  - Draft     : the default. Being written, never announced.
 *  - Scheduled : finished, waiting for published_at. albums:publish-scheduled
 *                flips it (App\Console\Commands\PublishScheduledAlbums).
 ...
 *
 * Published is reachable from every state so an album can always go back up,
 * and Hidden from every state that carries a public commitment so it can always
 * come down. Draft cannot be reached from Published — pulling a live album is an
 ...
 */
abstract class AlbumStatus extends State
{
