...
class StoreNotificationGroupData extends Data
{
    /**
    ...
    public static function rules(ValidationContext $context): array
    {
        return [
            ...
            'code' => ['required', 'string', 'max:255', Rule::unique('notification_groups', 'code')],
            ...
            // The whole catalogue is subscribable — there is nothing here to
            // exclude and no type a group may not tick.
