<script>
    ...
    async function deleteMedia(mediaId) {
        ...
        try {
            ...
            const response = await fetch(route('admin.media.destroy', { media: mediaId }), {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
            ...
            if (response.ok) {
                ...
                const errorMessage = errorData.message || 'Error deleting media. Please try again.';
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex flex-col gap-1">
                    <h1 class="text-2xl font-bold text-mono">Media Management</h1>
                    <p class="text-sm text-secondary-foreground">
                        Manage your website media and content
                    </p>
                </div>
                <div class="flex items-center gap-3">
                    {#if hasPermission('admin.media.store')}
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[200px]">
                                        <span class="kt-table-col">
                                            <span class="kt-table-col-label">Media</span>
                                        </span>
                                    </th>
                                    ...
                                    <tr>
                                        <td colspan="8" class="p-10">
                                            <div class="flex flex-col items-center justify-center text-center">
                                                ...
                                                <h3 class="text-lg font-semibold text-mono mb-2">No media found</h3>
                                                <p class="text-sm text-secondary-foreground mb-4">
                                                    {search ? 'No media match your search criteria.' : 'Get started by creating your first media.'}
                                                </p>
                                                {#if hasPermission('admin.media.store')}
                                                <a href="{route('admin.media.create')}" class="kt-btn kt-btn-primary">
                                                    <i class="ki-filled ki-plus text-base"></i>
                                ...
                                {:else}
                                    ...
                                    {#each media as media}
                                        <tr class="hover:bg-muted/50">
                                            <td>
                                                <input class="kt-checkbox kt-checkbox-sm" type="checkbox" value={media.id}/>
                                            </td>
                                            <td>
                                                <span class="text-sm font-medium text-mono">#{media.id}</span>
                                            </td>
                                            <td>
                                                ...
                                                <div class="kt-menu flex-inline" data-kt-menu="true">
                                                    <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                                                        ...
                                                        <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                            {#if hasPermission('admin.media.show')}
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link" href={route('admin.media.show', { media: media.id })}>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link" href={route('admin.media.edit', { media: media.id })}>
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            {/if}
                                                            {#if hasPermission('admin.media.destroy')}
                                                                <div class="kt-menu-separator"></div>
                                                                <div class="kt-menu-item">
                                                                    <button class="kt-menu-link" on:click={() => deleteMedia(media.id)}>
                                                                        <span class="kt-menu-icon">
