<script>
    ...
    const pageTitle = 'Create Partner';
    ...
    function handleSubmit() {
        ...
        Object.keys(form).forEach(key => {
            if (form[key] !== null && form[key] !== '') {
                ...
                } else if (key !== 'file' && key !== 'media_option') {
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex flex-col gap-1">
                    <h1 class="text-2xl font-bold text-mono">Create New Partner</h1>
                            ...
                            {#if form.media_option === 'upload'}
                                <div class="flex flex-col gap-2">
                                    <label class="text-sm font-medium text-mono" for="file">
                                        Upload Logo <span class="text-destructive">*</span>
                                    </label>
                                    <input
                                        id="file"
                                        type="file"
