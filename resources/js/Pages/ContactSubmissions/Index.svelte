<script>
    ...
    const pageTitle = 'Contact Submissions';
    ...
    async function deleteContactSubmission(contactSubmissionId) {
        ...
        try {
            ...
            const response = await fetch(route('admin.contact-submissions.destroy', { contactSubmission: contactSubmissionId }), {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
            ...
            if (response.ok) {
                ...
                const errorMessage = errorData.message || 'Error deleting contact submission. Please try again.';
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex flex-col gap-1">
                    <h1 class="text-2xl font-bold text-mono">Contact Submissions Management</h1>
                        ...
                        <table class="kt-table kt-table-border table-fixed">
                            ...
                            <tbody>
                                {#if loading}
                                    ...
                                    {/each}
                                {:else if contactSubmissions.length === 0}
                                    <!-- Empty state -->
                                    <tr>
                                        <td colspan="6" class="p-10">
                                            <div class="flex flex-col items-center justify-center text-center">
                                                ...
                                                <h3 class="text-lg font-semibold text-mono mb-2">No contact submissions found</h3>
                                                <p class="text-sm text-secondary-foreground mb-4">
                                                    {search ? 'No contact submissions match your search criteria.' : 'No contact submissions have been submitted yet.'}
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                                {:else}
                                    <!-- Actual data rows -->
                                    {#each contactSubmissions as contactSubmission}
                                        <tr class="hover:bg-muted/50">
                                            <td>
                                                <input class="kt-checkbox kt-checkbox-sm" type="checkbox" value={contactSubmission.id}/>
                                            </td>
                                            <td>
                                                <span class="text-sm font-medium text-mono">#{contactSubmission.id}</span>
                                            </td>
                                            <td>
                                                <div class="flex flex-col gap-1">
                                                ...
                                                <div class="kt-menu flex-inline" data-kt-menu="true">
                                                    <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                                                        ...
                                                        <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                            {#if hasPermission('admin.contact-submissions.show')}
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link" href={route('admin.contact-submissions.show', { contactSubmission: contactSubmission.id })}>
                                                            ...
                                                            {/if}
                                                            {#if hasPermission('admin.contact-submissions.destroy')}
                                                                <div class="kt-menu-separator"></div>
                                                                <div class="kt-menu-item">
                                                                    <button class="kt-menu-link" on:click={() => deleteContactSubmission(contactSubmission.id)}>
                                                                        <span class="kt-menu-icon">
