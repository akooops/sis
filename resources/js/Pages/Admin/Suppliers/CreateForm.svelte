<script>
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            const response = await fetch(route('api.v1.admin.suppliers.store'), {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                if (data.errors) {
                    ...
                    console.error('Error creating supplier:', data.message || 'Unknown error');
                }
            }
        } catch (error) {
        ...
        <div class="flex items-center justify-end gap-3 pt-4 border-t border-border">
            ...
            >
                {#if loading}
                    ...
                    Creating...
                {:else}
                    <i class="fa-solid fa-truck-field mr-2"></i>
                    Create Supplier
                {/if}
            </button>
        </div>
