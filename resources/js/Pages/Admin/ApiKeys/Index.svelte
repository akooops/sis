<script>
    ...
    function menuGroups() {
        return {
            status: hasPermission('api-keys.rotate') || hasPermission('api-keys.revoke'),
            related: hasPermission('activities.index') || hasPermission('api-key-permissions.index'),
            danger: hasPermission('api-keys.destroy'),
        };
    }
