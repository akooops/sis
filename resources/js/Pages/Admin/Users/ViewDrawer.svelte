    ...
    <div class="kt-card-content flex flex-col space-y-4 p-5 kt-scrollable-y-auto">
            ...
            <div class="space-y-4">
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-medium word-break">#{selectedUser.id}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium text-muted-foreground min-w-20">Name:</span>
                        <span class="text-sm font-medium text-mono word-break">{selectedUser.firstname} {selectedUser.lastname}</span>
                    </div>

                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium text-muted-foreground min-w-20">Username:</span>
                        <span class="text-sm font-medium text-mono word-break">@{selectedUser.name}</span>
                    </div>

                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium text-muted-foreground min-w-20">Email:</span>
                        <span class="text-sm font-medium text-mono word-break">{selectedUser.email}</span>
                    </div>

                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium text-muted-foreground min-w-20">Phone:</span>
                        {#if selectedUser.phone}
                            <span class="text-sm font-medium text-mono word-break">{selectedUser.phone}</span>
                        {:else}
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex flex-col">
                            <span class="text-sm font-medium">{formatTimeStamp(selectedUser.created_at)}</span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div class="flex flex-col">
                            <span class="text-sm font-medium">{formatTimeStamp(selectedUser.updated_at)}</span>
                        </div>
                    </div>
                </div>
        ...
        {:else}
            ...
            <div class="flex flex-col items-center justify-center text-center p-8">
                ...
                <h3 class="text-lg font-semibold text-mono mb-2">No User Selected</h3>
