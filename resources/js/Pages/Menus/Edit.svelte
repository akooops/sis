<script>
    ...
    const breadcrumbs = [
        ...
        {
            title: 'Edit',
            url: route('admin.menus.edit', { menu: menu?.id }),
            active: true
        }
    ];
    ...
    function handleSubmit() {
        ...
        router.post(route('admin.menus.update', { menu: menu.id }), formData, {
            onError: (err) => {
                errors = err;
                loading = false;
            },
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex flex-col gap-1">
                    <h1 class="text-2xl font-bold text-mono">Edit Menu</h1>
                    <p class="text-sm text-secondary-foreground">
                        Update menu information and content
                    </p>
                </div>
