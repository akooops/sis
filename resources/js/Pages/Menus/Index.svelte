<script>
    ...
    async function deleteMenu(menuId) {
        ...
        try {
            ...
            const response = await fetch(route('admin.menus.destroy', { menu: menuId }), {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
            ...
            if (response.ok) {
                ...
                const errorMessage = errorData.message || 'Error deleting menu. Please try again.';
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex flex-col gap-1">
                    ...
                    <p class="text-sm text-secondary-foreground">
                        Manage your website menus and content
                    </p>
                </div>
                <div class="flex items-center gap-3">
                    {#if hasPermission('admin.menus.store')}
                    <a href="{route('admin.menus.create')}" class="kt-btn kt-btn-primary">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[200px]">
                                        <span class="kt-table-col">
                                            <span class="kt-table-col-label">Menu</span>
                                        </span>
                                    </th>
                                    <th class="w-[80px]">
                                        <span class="kt-table-col">
                                    ...
                                    <tr>
                                        <td colspan="8" class="p-10">
                                            <div class="flex flex-col items-center justify-center text-center">
                                                ...
                                                <h3 class="text-lg font-semibold text-mono mb-2">No menus found</h3>
                                                <p class="text-sm text-secondary-foreground mb-4">
                                                    {search ? 'No menus match your search criteria.' : 'Get started by creating your first menu.'}
                                                </p>
                                                {#if hasPermission('admin.menus.store')}
                                                <a href="{route('admin.menus.create')}" class="kt-btn kt-btn-primary">
                                                    <i class="ki-filled ki-plus text-base"></i>
                                ...
                                {:else}
                                    ...
                                    {#each menus as menu}
                                        <tr class="hover:bg-muted/50">
                                            <td>
                                                <input class="kt-checkbox kt-checkbox-sm" type="checkbox" value={menu.id}/>
                                            </td>
                                            <td>
                                                <span class="text-sm font-medium text-mono">#{menu.id}</span>
                                            </td>
                                            <td>
                                                <div class="flex flex-col gap-1">
                                                ...
                                                <div class="kt-menu flex-inline" data-kt-menu="true">
                                                    <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                                                        ...
                                                        <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link" href={route('admin.menus.edit', { menu: menu.id })}>
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            {/if}
                                                            {#if hasPermission('admin.menus.destroy')}
                                                                <div class="kt-menu-separator"></div>
                                                                <div class="kt-menu-item">
                                                                    <button class="kt-menu-link" on:click={() => deleteMenu(menu.id)}>
                                                                        <span class="kt-menu-icon">
