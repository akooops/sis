    ...
    <div class="kt-container-fixed flex justify-between items-stretch lg:gap-4" id="headerContainer">
        ...
        <div class="flex gap-2.5 lg:hidden items-center -ms-1">
            <a class="shrink-0" href={route('web.admin.dashboard')} use:inertia>
                <img class="max-h-[25px] w-full" src="/assets/admin/media/app/mini-logo.png" alt="Logo" />
            </a>
        ...
        <div class="flex items-center gap-2.5">
            ...
            >
                <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
                    <img class="size-9 rounded-full border-2 border-green-500 shrink-0" src={user?.avatar_url || '/assets/admin/media/app/mini-logo.png'} alt={user?.username} />
                </div>
                <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
                    <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
                        <div class="flex items-center gap-2">
                            <img class="size-9 shrink-0 rounded-full border-2 border-green-500" src={user?.avatar_url || '/assets/admin/media/app/mini-logo.png'} alt={user?.username} />
