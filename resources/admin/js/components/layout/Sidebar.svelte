...
>
    <div class="kt-sidebar-header hidden lg:flex items-center relative justify-between px-3 lg:px-6 shrink-0" id="sidebar_header">
        <a href={href('web.admin.dashboard')} use:inertia>
            <img class="default-logo h-[42px] max-w-none" src="/assets/admin/media/app/mini-logo.png" alt="Logo" />
            <img class="small-logo h-[22px] max-w-none" src="/assets/admin/media/app/mini-logo.png" alt="Logo" />
        </a>
        <button
