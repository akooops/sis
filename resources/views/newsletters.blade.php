            ...
            <div id="accordion-3" class="accordion-wrapper">
                <div class="card accordion-item">
                    <div class="card-header" id="accordion-heading-3-1">
                        <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#newsletters-collapse" aria-expanded="false" aria-controls="newsletters-collapse">
                            {{getLanguageKeyLocalTranslation('newsletters_page_collapse_title')}}
                        </button>
                    </div>
                    <!-- /.card-header -->
                    <div id="newsletters-collapse" class="collapse show">
                        <div class="card-body">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" width="90%">
                                                {{getLanguageKeyLocalTranslation('newsletters_page_table_header_file')}}
                                            </th>
                                            <th scope="col">
                                                {{getLanguageKeyLocalTranslation('newsletters_page_table_header_option')}}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($newsletters as $key => $newsletter)
                                            <tr>
                                                ...
                                                <td>
                                                    {{$newsletter->getLocalTranslation('title')}}
                                                </td>
                                                <td>
                                                    <a href="{{$newsletter->newsletterUrl}}" target="_blank" class="btn btn-sm btn-primary">
                                                        <i class="uil uil-angle-right-b me-2"></i>

                                                        {{getLanguageKeyLocalTranslation('newsletters_page_table_cta')}}
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
