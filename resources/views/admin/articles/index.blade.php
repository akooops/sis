            ...
            <div class="row mb-3 pb-1">
                <div class="col-12">
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        ...
                        @haspermission('admin.articles.store')
                        <div class="mt-3 mt-lg-0">
                            <form action="javascript:void(0);">
                                <div class="row g-3 mb-0 align-items-center">
                                    <div class="col-auto">
                                        <a href="{{ route('admin.articles.create') }}" class="btn btn-soft-success"><i
                ...
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="fw-semibold">
                                                <a href="#" class="fw-semibold">#{{$article->id}}</a>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <a href="#" article="button" id="dropdownMenuLink1" data-bs-toggle="dropdown" aria-expanded="false" class="">
                                                        <i class="ri-more-2-fill"></i>
                                                    </a>

                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="">
                                                        @haspermission('admin.articles.show')
                                                            <li><a class="dropdown-item" href="{{route('admin.articles.show', $article->id)}}"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                                        @endhaspermission

                                                        @haspermission('admin.articles.update')
                                                            <li><a class="dropdown-item" href="{{route('admin.articles.edit', $article->id)}}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                        @endhaspermission

                                                        @haspermission('admin.articles.destroy')
                        ...
                        <div class="card-footer">
                            @component('admin.components.pagination', ['route' => 'admin.articles.index', 'pagination' => $pagination])@endcomponent
                        </div>
                    </div>
                </div>
            </div>
