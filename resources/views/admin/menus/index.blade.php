            ...
            <div class="row mb-3 pb-1">
                <div class="col-12">
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        ...
                        @haspermission('admin.menus.store')
                        <div class="mt-3 mt-lg-0">
                            <form action="javascript:void(0);">
                                <div class="row g-3 mb-0 align-items-center">
                                    <div class="col-auto">
                                        <a href="{{ route('admin.menus.create') }}" class="btn btn-soft-success"><i
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column flex-sm-row justify-content-sm-start mb-2">
                                <div class="search-box flex-grow-1 mb-2">
                                    <form action="{{route('admin.menus.index')}}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="fw-semibold">
                                                <a href="#" class="fw-semibold">#{{$menu->id}}</a>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <a href="#" menu="button" id="dropdownMenuLink1" data-bs-toggle="dropdown" aria-expanded="false" class="">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="">
                                                        ...
                                                        @haspermission('admin.menus.destroy')
                        ...
                        <div class="card-footer">
                            @component('admin.components.pagination', ['route' => 'admin.menus.index', 'pagination' => $pagination])@endcomponent
                        </div>
                    </div>
                </div>
            </div>
