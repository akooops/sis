                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column flex-sm-row justify-content-sm-start mb-2">
                                <div class="search-box flex-grow-1 mb-2">
                                    <form action="{{route('admin.permissions.index')}}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="fw-semibold">
                                                <a href="#" class="fw-semibold">#{{$permission->id}}</a>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="">
                                                        @haspermission('admin.permissions.show')
                                                            <li><a class="dropdown-item" href="{{route('admin.permissions.show', $permission->id)}}"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                                        @endhaspermission
                                                    </ul>
                                                </div>
                                            </td>
                        ...
                        <div class="card-footer">
                            @component('admin.components.pagination', ['route' => 'admin.permissions.index', 'pagination' => $pagination])@endcomponent
                        </div>
                    </div>
                </div>
            </div>
