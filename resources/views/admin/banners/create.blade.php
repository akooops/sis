...
@slot('title') Create Banner @endslot
@endcomponent
<div class="row">
    <div class="col">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="">Banner thumbnail <span class="text-danger">*</span></label>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4">
                                    <label class="form-label" for="">Banner {{$defaultLanguage->name}} title <span class="text-danger">*</span></label>
