...
@slot('title') Edit Event Edition @endslot
@endcomponent
<div class="row">
    <div class="col">
        ...
        <div class="h-100">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('eventEditions.update', $eventEdition->id) }}">
                @method('patch')
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input name="name" value="{{$eventEdition->name}}" type="text" class="form-control">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" type="text" class="form-control">{{$eventEdition->description}}</textarea>
                                    @error('description')
                                        <p class="mx-2 my-2 text-danger">
                                            <strong>
                                                {{$message}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="participants" value="{{$eventEdition->participants}}" type="number" class="form-control">
                                    @error('participants')
                                        <p class="mx-2 my-2 text-danger">
                                            <strong>
                                                {{$message}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="place" value="{{$eventEdition->place}}" type="text" class="form-control">
                                    @error('place')
                                        <p class="mx-2 my-2 text-danger">
                                            <strong>
                                                {{$message}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="starts_at" value="{{$eventEdition->starts_at}}" type="text" id="datepicker-from-input" class="form-control flatpickr-input" data-provider="flatpickr" data-date-format="Y-m-d"readonly="readonly">
                                    @error('starts_at')
                                        <p class="mx-2 my-2 text-danger">
                                            <strong>
                                                {{$message}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="ends_at" value="{{$eventEdition->ends_at}}" type="text" id="datepicker-from-input" class="form-control flatpickr-input" data-provider="flatpickr" data-date-format="Y-m-d" readonly="readonly">
                                    @error('ends_at')
                                        <p class="mx-2 my-2 text-danger">
                                            <strong>
                                                {{$message}}
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <label class="form-label mb-3" for="">Last uploaded images:</label>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div id="img-{{$key}}" class="col-4 col-md-2">
                                        <figure class="figure" style="width: 100%">
                                            ...
                                            <span onclick="imgDelete('{{$image->id}}', '{{$key}}')" class="position-absolute topbar-badge fs-8 translate-middle badge rounded-pill bg-danger" style="cursor: pointer">x</span>
                                        </figure>
                                    </div>
                                    @endforeach
                                </div>
...
<script>
    function imgDelete(id, key){
        if(confirm('Are you sure you want to delete this?')){
            ...
            $.ajax({
                url: '{{ url("admin/files/deleteById") }}' + '/' + id,
                type: 'POST',
                success: function(data) {
                    const element = document.getElementById("img-" + key);
                    element.remove();
                }
            });
        }
