                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.menu-items.update', $menuItem->id) }}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="">Menu Item slug<span class="text-danger">*</span></label>
                                    <input name="slug" value="{{old('slug', $menuItem->slug)}}" type="text" class="form-control">
                                    @error('slug')
                                        <p class="mx-2 my-2 text-danger">
                                            <strong>
                                                {{$message}}
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="">Menu Item status<span class="text-danger">*</span></label>
                                    <select class="form-control" name="status">
                                        <option value="draft" {{ $menuItem->status == 'draft' ? 'selected' : '' }}>Draft</option>
                                        <option value="hidden" {{ $menuItem->status == 'hidden' ? 'selected' : '' }}>Hidden</option>
                                        <option value="published" {{ $menuItem->status == 'published' ? 'selected' : '' }}>Published</option>
                                    </select>
                                    @error('status')
                                        <p class="mx-2 my-2 text-danger">
                                            <strong>
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="">Menu Item thumbnail <span class="text-danger">(Keep it empty if you don't want to change it)</span></label>
                                ...
                                <div class="mt-4">
                                    <figure class="figure">
                                        <img src="{{ $menuItem->thumbnailUrl }}" class="rounded avatar-xl" style="object-fit: cover">
                                    ...
                                    <div class="tab-pane {{$key == 0 ? "active" : ""}}" id="{{$language->code}}" role="tabpanel">
                                        <form class="translation-form" data-language="{{$language->code}}" data-language-id="{{$language->id}}">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <textarea id="description-{{$language->id}}" name="description" class="form-control translation-description" rows="3">{{$menuItem->getTranslation('description', $language->code)}}</textarea>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <textarea id="content-{{$language->id}}" name="content" class="form-control translation-content markdown-editor">{{$menuItem->getTranslation('content', $language->code)}}</textarea>
