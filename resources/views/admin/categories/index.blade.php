                    ...
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        ...
                        <div class="mt-3 mt-lg-0">
                            ...
                            <div class="row g-3 mb-0 align-items-center">
                                <div class="col-auto">
                                    <a href="{{ route('categories.create') }}" class="btn btn-soft-success"><i
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="to-be-destroyed-container">
                                <form action="{{route('categories.destroyMultiple')}}" method="POST">
                                    @csrf
                                    @method('post')
                                ...
                                <table class="table align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="form-check">
                                                    <input class="form-check-input row-checkbox" type="checkbox" value="{{ $category->id }}" oninput="checkRow()">
                                                    <label class="form-check-label"></label>
                                                </div>
                                            </th>
                                            <td>
                                                <a href="#" class="fw-semibold">#{{$category->id}}</a>
                                            </td>                                            
                                            <td>{{ $category->name }}</td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    @canany(['categories.show'])
                                                    <div class="show">
                                                        <a href="{{ route('categories.show', $category->id) }}" class="btn btn-sm btn-info show-item-btn">Show</a>
                                                    </div>
                                                    @endcanany
                                                    
                                                    @canany(['categories.edit'])
                                                    <div class="edit">
                                                        <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-sm btn-success edit-item-btn">Edit</a>
                                                    </div>
                                                    @endcanany
                        ...
                        <div class="card-footer">
                            @component('admin.components.pagination', ['route' => 'categories.index', 'pagination' => $pagination])@endcomponent
                        </div>
                    </div>
                </div>
            </div>
