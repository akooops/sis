                    ...
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        ...
                        <div class="mt-3 mt-lg-0">
                            ...
                            <div class="row g-3 mb-0 align-items-center">
                                <div class="col-auto">
                                    <a href="{{ route('posts.create') }}" class="btn btn-soft-success"><i
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Manage Posts</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="form-check">
                                                    <input class="form-check-input row-checkbox" type="checkbox" value="{{ $post->id }}" oninput="checkRow()">
                                            ...
                                            <td>
                                                <img src="{{$post->image->fullpath}}" alt="" class="rounded avatar-md" style="object-fit: cover">
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    @canany(['posts.approve'])
                                                        <div class="show">
                                                            <form action="{{ route('posts.approve', $post->id) }}" method="POST">
                                                                @csrf
                                                                <button type="submit" class="btn btn-sm btn-{{ $post->approved ? 'danger' : 'primary' }}">
                                                    ...
                                                    @canany(['posts.show'])
                                                    <div class="show">
                                                        <a href="{{ route('posts.show', $post->id) }}" class="btn btn-sm btn-info show-item-btn">Show</a>
                                                    </div>
                                                    @endcanany
                                                    
                                                    @canany(['posts.edit'])
                                                    <div class="edit">
                                                        <a href="{{ route('posts.edit', $post->id) }}" class="btn btn-sm btn-success edit-item-btn">Edit</a>
                                                    </div>
                                                    @endcanany
                        ...
                        <div class="card-footer">
                            @component('admin.components.pagination', ['route' => 'posts.index', 'pagination' => $pagination])@endcomponent
                        </div>
                    </div>
                </div>
            </div>
