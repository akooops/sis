                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category_id" class="form-select">
                                        ...
                                        @foreach($categories as $category)
                                            <option {{ $category->id == $post->category_id
                                                ? 'selected'
                                                : '' }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="overview" type="text" class="form-control">{{$post->overview}}</textarea>
                                    @error('overview')
                                        <p class="mx-2 my-2 text-danger">
                                            <strong>
                                                {{$message}}
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="">Post Image <span class="text-danger">Don't Upload an image if you don't want to change the image</span></label>
                                ...
                                <div class="mb-3">
                                    <figure class="figure">
                                        <img src="{{ $post->image->fullpath }}" class="rounded avatar-xl" style="object-fit: cover">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input name="reading_time" value="{{$post->reading_time}}" type="number" min="0" class="form-control">
                                    @error('reading_time')
                                        <p class="mx-2 my-2 text-danger">
                                            <strong>
                                                {{$message}}
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="published" value="{{$post->published}}" type="text" id="datepicker-from-input" class="form-control flatpickr-input" data-provider="flatpickr" data-date-format="Y-m-d" data-time_24hr="true" data-enable-time="true"  readonly="readonly">
                                    @error('published')
                                        <p class="mx-2 my-2 text-danger">
                                            <strong>
                                                {{$message}}
...
<script>
    ...
    Sources = new Vue({
        ...
        methods : {
            ...
            splitPrevSources: function(){
                if(this.prev_sources === "") return;
                
                this.prev_sources.split(';;;').forEach(prev_source => {
                    let source = {
                        content: prev_source
                    };
