...
@slot('title') Create Media @endslot
@endcomponent
<div class="row">
    <div class="col">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="">Media file<span class="text-danger">*</span></label>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4">
                                    <label class="form-label" for="">Media {{$defaultLanguage->name}} title <span class="text-danger">*</span></label>
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="">Media {{$defaultLanguage->name}} description <span class="text-danger">*</span></label>
