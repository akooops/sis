...
@slot('title') Create Album @endslot
@endcomponent
<div class="row">
    <div class="col">
        ...
        <div class="h-100">
            ...
            <form id="main-form" method="POST" enctype="multipart/form-data" action="{{ route('admin.albums.store') }}">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="">Album thumbnail <span class="text-danger">*</span></label>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4">
                                    <label class="form-label" for="">Album {{$defaultLanguage->name}} title <span class="text-danger">*</span></label>
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="">Album {{$defaultLanguage->name}} description <span class="text-danger">*</span></label>
