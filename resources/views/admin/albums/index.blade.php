            ...
            <div class="row mb-3 pb-1">
                <div class="col-12">
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        ...
                        @haspermission('admin.albums.store')
                        <div class="mt-3 mt-lg-0">
                            <form action="javascript:void(0);">
                                <div class="row g-3 mb-0 align-items-center">
                                    <div class="col-auto">
                                        <a href="{{ route('admin.albums.create') }}" class="btn btn-soft-success"><i
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column flex-sm-row justify-content-sm-start mb-2">
                                <div class="search-box flex-grow-1 mb-2">
                                    <form action="{{route('admin.albums.index')}}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="fw-semibold">
                                                <a href="#" class="fw-semibold">#{{$album->id}}</a>
                                            </td>

                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ $album->thumbnailUrl }}" class="avatar-xs material-shadow">
                                                    </div>
                                                    <div class="flex-grow-1">{{ $album->name }}</div>
                                                </div>
                                            </td>  
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <a href="#" album="button" id="dropdownMenuLink1" data-bs-toggle="dropdown" aria-expanded="false" class="">
                                                        <i class="ri-more-2-fill"></i>
                                                    </a>

                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="">
                                                        @haspermission('admin.albums.show')
                                                            <li><a class="dropdown-item" href="{{route('admin.albums.show', $album->id)}}"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                                        @endhaspermission

                                                        @haspermission('admin.albums.update')
                                                            <li><a class="dropdown-item" href="{{route('admin.albums.edit', $album->id)}}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                        @endhaspermission

                                                        @haspermission('admin.albums.destroy')
                        ...
                        <div class="card-footer">
                            @component('admin.components.pagination', ['route' => 'admin.albums.index', 'pagination' => $pagination])@endcomponent
                        </div>
                    </div>
                </div>
            </div>
