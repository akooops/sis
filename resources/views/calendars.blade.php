            ...
            <div id="accordion-3" class="accordion-wrapper">
                <div class="card accordion-item">
                    <div class="card-header" id="accordion-heading-3-1">
                        <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#forms-collapse" aria-expanded="false" aria-controls="forms-collapse">
                            {{getLanguageKeyLocalTranslation('calendars_page_collapse_title')}}
                        </button>
                    </div>
                    <!-- /.card-header -->
                    <div id="forms-collapse" class="collapse show">
                        <div class="card-body">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">
                                                {{getLanguageKeyLocalTranslation('calendars_page_table_header_calendar')}}
                                            </th>
                                            <th scope="col">
                                                {{getLanguageKeyLocalTranslation('calendars_page_table_header_start_date')}}
                                            </th>
                                            <th scope="col">
                                                {{getLanguageKeyLocalTranslation('calendars_page_table_header_end_date')}}
                                            </th>
                                            <th scope="col">
                                                {{getLanguageKeyLocalTranslation('calendars_page_table_header_option')}}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($calendars as $key => $calendar)
                                            <tr>
                                                ...
                                                <td>
                                                    {{$calendar->getLocalTranslation('title')}}
                                                </td>
                                                <td>
                                                    {{$calendar->starts_at->format('Y-m-d')}}
                                                </td>
                                                <td>
                                                    {{$calendar->ends_at->format('Y-m-d')}}
                                                </td>
                                                <td>
                                                    <a href="{{$calendar->calendarUrl}}" target="_blank" class="btn btn-sm btn-primary">
                                                        <i class="uil uil-angle-right-b me-2"></i>

                                                        {{getLanguageKeyLocalTranslation('calendars_page_table_cta')}}
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
