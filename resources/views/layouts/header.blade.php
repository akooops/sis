<header class="wrapper">
    <nav class="navbar navbar-expand-lg classic navbar-dark navbar-bg-dark py-2">
    <div class="container flex-lg-row flex-nowrap align-items-center">
        ...
        <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    ) ? 'active' : ''}}"  href="{{route('posts')}}">Articles</a>
                </li>   
                <li class="nav-item">
                    <a class="nav-link {{(
                        request()->routeIs('events') || 
                        request()->routeIs('edition')
                    ) ? 'active' : ''}}"  href="{{route('events')}}">Évènements</a>
                </li>  
            </ul>
            <!-- /.navbar-nav -->
        ...
        -->
            <li class="nav-item d-none d-md-block">
                <a href="{{route('contact')}}" class="btn btn-md btn-primary rounded">Nous Contacter</a>
            </li>
