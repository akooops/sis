        ...
        <div class="container pb-14 pt-6">
            <div class="card">
                <div class="card-header">
                    <button type="button" class="panel-toggle" data-toggle="collapse" data-target="#documents-panel"
                        aria-expanded="true" aria-controls="documents-panel">
                        @lang('site.documents.panel')
                    </button>
                </div>

                <div id="documents-panel" class="collapse-panel is-open" aria-hidden="false">
                    <div>
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($documents as $document)
                                            @php($file = $document->getMedia(\App\Models\Document::FILE_COLLECTION)->first())

                                            <tr>
                                                <td>{{ $document->getTranslation('title', $site->locale(), true) ?: $document->name }}</td>
