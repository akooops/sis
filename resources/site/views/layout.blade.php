{{--
    ...
    Everything the site owns lives under resources/site/ — its own css, js and
    views, built as its own Vite bundle. Nothing here may reach into
    resources/admin/.

    What is NOT temporary and must survive that redesign:
      - the @vite entries below (site.css / site.js, never the admin's app.*,
        which would drag the whole Metronic admin theme onto a public page);
