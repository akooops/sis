...
Route::middleware(['auth', 'force.admin.english', 'handle.inertia'])->prefix('admin')->group(function () {
    ...
    Route::post('language-keys/{languageKey}/update-translation', [LanguagesKeysController::class, 'updateTranslation'])->middleware('check.permission:admin.language-keys.update')->name('admin.language-keys.update-translation');
    ...
    Route::post('visit-services/{visitService}/visit-time-slots/bulk', [VisitTimeSlotsController::class, 'bulkStore'])->middleware('check.permission:admin.visit-time-slots.store')->name('admin.visit-time-slots.bulk-store');
