    ...
    private function addPageTranslations($page)
    {
        $translations = [
            ...
            'newsletters' => [
                ...
                'description' => [
                    'en' => 'A vital communication bridge between home and school, keeping parents, and students, informed about events and activities!',
                    'ar' => 'جسر تواصل حيوي بين المنزل والمدرسة، يبقي أولياء الأمور والطلاب على اطلاع بالفعاليات والأنشطة!',
                ],
                'content' => [
                    'en' => 'Stay connected with our school community through our newsletters. Get the latest updates on events, activities, and important announcements delivered directly to you.',
                    'ar' => 'ابقَ على تواصل مع مجتمعنا المدرسي من خلال نشراتنا الإخبارية. احصل على آخر التحديثات حول الفعاليات والأنشطة والإعلانات المهمة.',
                ],
            ],
            'error' => [
                'title' => [
